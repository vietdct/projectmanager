        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
                <div class="navbar-header"> 
                    ...
                    <ul class="nav navbar-top-links navbar-left m-l-20 hidden-xs">
                        <li>
                            <form action="<c:url value='/searchUser'/>" method="get" class="app-search hidden-xs">
                                <input type="text" name="valueSearch" placeholder="Search..." class="form-control"> 
                                 
	                                <a href="">
	                                    <i class="fa fa-search btn-search" data-user-name="${listUser.role.name }"></i>
	                                </a>
