                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <form action=
                             ...
                             "<c:url value='/admin/role-edit/${role.id}'/>" method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="description" value="${role.description}" type="text" placeholder="" class="form-control form-control-line" />
                                    </div>
