            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                    	<c:url var="task_add" value="/admin/task-add"/>
                        <a href="${task_add }" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach items="${listTask}" var="listTask">
                                        ...
                                        <tr>
                                            <td>${listTask.id}</td>
                                            <td>${listTask.name}</td>
                                            <td>${listTask.projectName}</td>
                                            <td>${listTask.lastName}</td>
                                            <td>${listTask.startDate}</td>
                                            <td>${listTask.endDate}</td>
                                            <td>${listTask.statusName}</td>
                                            <td>
